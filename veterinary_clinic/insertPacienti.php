...
?>
        ...
        <form action = "includes/insertPacienti.inc.php" method = "POST">
            <tr>
                <td> <input type = "text" placeholder = "CNP Proprietar" name = "cnpProprietar"> </td>
                ...
                <td> <button type = "submit" class = "iudButton">Insert</button></td>
            </tr>
        </form>
    ...
    <?php
        ...
        if (isset($_GET["error"])) {
            if($_GET["error"] == "emptyinput") {
                echo '<h4>Campurile nume, specie, rasa (poate fi Necunoscuta), sex si culoare sunt obilgatorii</h4>';
            }
        }
        ...
        if (isset($_GET["error"])) {
            if($_GET["error"] == "invalidMicrohip") {
                echo '<h4>Numarul de microchip introdus este invalid</h4>';
            }
        }
