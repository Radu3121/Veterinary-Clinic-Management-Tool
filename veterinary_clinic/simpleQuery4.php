...
<div>
    ...
    <div class = "queryContent">
        ...
        <?php
            ...
            $query = "SELECT PA.Nume AS NumePacient, PA.CodPacient, CONCAT(A.Nume, ' ', A.Prenume)  AS NumeAsistent
                      FROM pacienti PA JOIN angajatipacienti AP ON (PA.PacientID = AP.PacientID)
                                       JOIN angajati A ON (AP.AngajatID = A.AngajatID)
                      WHERE A.Functie_Ocupata LIKE 'Asistent Veterinar'
            ...
            if ($resultCheck > 0) {
               echo '<table class = "tablestyle">
                <tr>
                    <th colspan = "3"><h3>Query 4 - Afisati asistentul care se ocupa de fiecare pacient</h3></th>
                </tr>
                <t>
                    <th> Nume Pacient </th>
                    <th> Cod Pacient </th>
